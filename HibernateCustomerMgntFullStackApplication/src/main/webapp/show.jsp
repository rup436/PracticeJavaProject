...
<body>
	...
	<div class="row">
		...
		<div class="container">
			...
			<input type="text" name="custaccountbalance">
			<input type="submit" value="Filter by Balance"> 
			</form>
			
			<form action="CustomerController" method="get">
			<input type="hidden" name="action" value="filterbyid">
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th> <a href="CustomerController?action=sortbyaccountbalance">Account Balance</a></th>
						<th>Gender</th>
				...
				<tbody>
					...
					<c:forEach var="customer" items="${customerList}">
						...
						<tr>
							...
							<td><a href="CustomerController?action=edit_form&custid=<c:out value='${customer.custId}' />">Update</a>
								 <a
